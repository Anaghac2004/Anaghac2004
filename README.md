...
| *Project*      | *Description*                                                                                  |
|-------------------|--------------------------------------------------------------------------------------------------|
| **[Predictive Patrol Using RL - A Temporal-Spatial Crime-Aware Approach](https://github.com/Anaghac2004/Predictive-Patrol-Routing-Using-RL)** | A Reinforcement Learning (PPO-based) patrol optimization system designed to improve police route planning using spatio-temporal crime forecasting. |
...
| **[Personal-Study-Planner](https://github.com/Anaghac2004/Personal-Study-Planner/blob/main/README.md)**    |A product management case study focused on building a study planning and time-tracking system to help students organize study sessions and improve exam preparation effectiveness. | 
